...
@Singleton
@Fallback
public class DocUnknownDistributor implements IDocUnknownDistributor {
    @Override
    public void transmit(final Recipient rcpt, final Function<MediaXType, MediaData> data, final MediaXType primaryFormat, final String documentTemplateId,
