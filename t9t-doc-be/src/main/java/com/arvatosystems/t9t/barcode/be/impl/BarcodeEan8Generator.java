...
@Named("EAN_8")
@Singleton
public class BarcodeEan8Generator extends AbstractImageGenerator {
    @Override
    public MediaData generateImage(final String text, final ImageParameter params) throws Exception {
        final BitMatrix m = new EAN8Writer().encode(text, BarcodeFormat.EAN_8, params.width, params.height);
