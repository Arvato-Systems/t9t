...
@Named("CODABAR")
@Singleton
public class BarcodeCodabarGenerator extends AbstractImageGenerator {
    @Override
    public MediaData generateImage(final String text, final ImageParameter params) throws Exception {
        final BitMatrix m = new CodaBarWriter().encode(text, BarcodeFormat.CODABAR, params.width, params.height);
