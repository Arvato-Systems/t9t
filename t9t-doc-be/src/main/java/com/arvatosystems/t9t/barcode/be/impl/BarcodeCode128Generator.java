...
@Named("CODE_128")
@Singleton
public class BarcodeCode128Generator extends AbstractImageGenerator {
    @Override
    public MediaData generateImage(final String text, final ImageParameter params) throws Exception {
        final BitMatrix m = new Code128Writer().encode(text, BarcodeFormat.CODE_128, params.width, params.height);
