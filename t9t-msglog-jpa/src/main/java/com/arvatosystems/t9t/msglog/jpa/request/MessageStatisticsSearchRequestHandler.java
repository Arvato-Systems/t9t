...
public class MessageStatisticsSearchRequestHandler extends AbstractSearch42RequestHandler<Long, MessageStatisticsDTO, WriteTracking, MessageStatisticsSearchRequest, MessageStatisticsEntity> {
    ...
    @Override
    public ReadAllResponse<MessageStatisticsDTO, WriteTracking> execute(final RequestContext ctx, final MessageStatisticsSearchRequest request) throws Exception {
