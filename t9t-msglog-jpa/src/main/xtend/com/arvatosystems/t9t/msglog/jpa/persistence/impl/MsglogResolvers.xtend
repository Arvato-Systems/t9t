...
class MsglogResolvers {
    ...
    def MessageEntity       getMessageEntity(MessageRef     entityRef) { return null; }

    @GlobalTenantCanAccessAll   // admin access to all tenant's data
    def MessageStatisticsEntity  getMessageStatisticsEntity(MessageStatisticsRef entityRef) { return null; }
}
