 ...
 */
package com.arvatosystems.t9t.vdb;
 ...
 *
 */
public class T9tVdbException extends T9tException {
    private static final long serialVersionUID = -866589612331210L;

    private static final int CORE_OFFSET            = T9tConstants.EXCEPTION_OFFSET_VDB;
    ...
    static {
        registerRange(CORE_OFFSET, false, T9tVdbException.class, ApplicationLevelType.FRAMEWORK, "t9t general AI integration layer");
