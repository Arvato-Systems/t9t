...
@AutoMap42
class AiAssistantMappers {
    IAiAssistantEntityResolver resolver
    @AutoHandler("S")
    def void e2dAiAssistantDTO(AiAssistantEntity entity, AiAssistantDTO dto) {}
    def void e2dAiAssistantDescription(AiAssistantEntity entity, AiAssistantDescription dto) {}
}
