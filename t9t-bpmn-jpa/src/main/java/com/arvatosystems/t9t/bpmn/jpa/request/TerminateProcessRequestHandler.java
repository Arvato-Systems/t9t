...
import com.arvatosystems.t9t.bpmn.request.TerminateProcessRequest;

import de.jpaw.dp.Jdp;
import jakarta.persistence.EntityManager;
import jakarta.persistence.EntityNotFoundException;

public class TerminateProcessRequestHandler extends AbstractRequestHandler<TerminateProcessRequest> {
    ...
    @Override
    public ServiceResponse execute(final RequestContext ctx, final TerminateProcessRequest request) throws Exception {
