 ...
 * @since 1.1
 */
public class JndiLdapRealm extends AuthorizingRealm implements ICacheableAuthorizationRealm {

    private static final Logger LOGGER = LoggerFactory.getLogger(JndiLdapRealm.class);
    ...
    //Matches the attributes of the external system to enable search
    private String phoneAttributeId;
    private String nameAttributeId;
...
//    }
    ...
    /**
     * @return the phoneAttributeId
     */
    public String getPhoneAttributeId() {
        return phoneAttributeId;
    }

    /**
     * @param phoneAttributeId the phoneAttributeId to set
     */
    public void setPhoneAttributeId(String phoneAttributeId) {
        this.phoneAttributeId = phoneAttributeId;
    }
    ...
    /**
     * @param nameAttributeId the nameAttributeId to set
     */
    ...
    /**
     * @param emailAttributeId the emailAttributeId to set
     */
