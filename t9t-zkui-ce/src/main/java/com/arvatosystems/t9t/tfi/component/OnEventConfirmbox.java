...
public abstract class OnEventConfirmbox implements EventListener<Event> {
    ...
    public void onEvent(Event event) throws Exception {
        ...
        Messagebox.show(session.translate(null, "com.confirm.message"), session.translate(null, "com.confirm"), Messagebox.OK | Messagebox.CANCEL,
                ...
                if (evt.getName().equals("onOK")) {
                    try {
                        ...
                        if (showSuccessMessage) {
                            Messagebox.show(session.translate(null, "success.transaction"), session.translate(null, "com.confirm"), Messagebox.OK,
