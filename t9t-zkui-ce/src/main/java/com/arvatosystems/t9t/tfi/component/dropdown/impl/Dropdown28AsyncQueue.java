...
public class Dropdown28AsyncQueue extends Dropdown28Db<DataSinkRef> {
    private static final long serialVersionUID = -17858802166923402L;

    public Dropdown28AsyncQueue() {
        super("asyncQueueId");
    }
}
