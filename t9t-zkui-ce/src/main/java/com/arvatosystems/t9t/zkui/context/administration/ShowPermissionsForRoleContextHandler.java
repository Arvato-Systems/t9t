...
@Singleton
@Named("role.ctx.showPermissions")
public class ShowPermissionsForRoleContextHandler implements IGridContextMenu<RoleDTO> {

    @Override
    public void selected(final Grid28 lb, final DataWithTracking<RoleDTO, TrackingBase> dwt) {
        final RoleDTO dto = dwt.getData();
        JumpTool.jump("screens/user_admin/permission28.zul", "roleRef", dto.getObjectRef(), "screens/user_admin/role28.zul");
    }
}
