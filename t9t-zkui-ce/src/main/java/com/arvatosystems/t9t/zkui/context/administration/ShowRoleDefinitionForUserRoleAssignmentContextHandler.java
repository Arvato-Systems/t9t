...
@Singleton
@Named("userTenantRole.ctx.showRoleDefinition")
public class ShowRoleDefinitionForUserRoleAssignmentContextHandler implements IGridContextMenu<UserTenantRoleDTO> {
    ...
    public void selected(final Grid28 lb, final DataWithTracking<UserTenantRoleDTO, TrackingBase> dwt) {
        ...
        JumpTool.jump("screens/user_admin/role28.zul", "objectRef", dto.getRoleRef().getObjectRef(), "screens/user_admin/userTenantRole28.zul");
    }
}
