...
@Singleton
@Named("schedulerSetup.ctx.showCannedJob")
public class SchedulerSetupToCannedJobContextHandler implements IGridContextMenu<SchedulerSetupDTO> {
    ...
    public void selected(final Grid28 lb, final DataWithTracking<SchedulerSetupDTO, TrackingBase> dwt) {
        ...
        JumpTool.jump("screens/scheduler/cannedRequest28.zul", "objectRef", dto.getRequest().getObjectRef(), "screens/scheduler/schedulerSetup28.zul");
    }
}
