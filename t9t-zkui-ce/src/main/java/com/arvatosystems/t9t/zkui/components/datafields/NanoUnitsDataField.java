...
public class NanoUnitsDataField extends AbstractDataField<NanoUnitsBox, NanoUnits> {
    ...
    public NanoUnitsDataField(DataFieldParameters params) {
        super(params);
    ...
    @Override
    public NanoUnitsBox getComponent() {
        return c;
    }

    @Override
    public void setValue(NanoUnits data) {
        c.setValue(data.toString());
    }

    @Override
    public NanoUnits getValue() {
        NanoUnits num = c.getValue();
        if (num == null)
            return null;
