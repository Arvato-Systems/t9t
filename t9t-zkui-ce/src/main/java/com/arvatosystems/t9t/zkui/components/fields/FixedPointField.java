...
public class FixedPointField extends AbstractField<Decimalbox> {
    @Override
    ...
    public FixedPointField(String fieldname, UIFilter cfg, FieldDefinition desc, String gridId, ApplicationSession session) {
