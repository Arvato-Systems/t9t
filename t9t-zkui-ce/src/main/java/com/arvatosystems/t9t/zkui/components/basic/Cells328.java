...
public class Cells328 extends Cells228 {
    ...
    private boolean formRegister3 = true; // if true then only this component will register with the parent Form28
    ...
    public void setValue3(Object t) {
        if (LOGGER.isTraceEnabled()) {
            ...
            LOGGER.trace("{}.setValue3({}) called (class {})", dataFieldId3, (getType3() != null && getType3().equals("password")) ? "*****" : t,
...
//    @Listen("onCreate")
    ...
    protected void myOnCreate() {
        ...
        FieldDefinition f = dataFieldId3.endsWith(T9tConstants.TENANT_ID_FIELD_NAME) ? InternalTenantId.meta$$tenantId
        ...
        if (dataField3 != null) {
            ...
            dataField3.addEventListener(Events.ON_CHANGE, (ev) -> {
                if (LOGGER.isTraceEnabled()) {
                    // mask value as ***** if type1 equals "password", for everything else log the value
                    LOGGER.trace("onChange caught for {}, current value is {}", dataFieldId3,
                            (getType3() != null && getType3().equals("password")) ? "*****" : getValue());
                }
    ...
    public boolean getFormRegister3() {
        return formRegister3;
    }

    public void setFormRegister3(boolean formRegister3) {
        this.formRegister3 = formRegister3;
    }
}
