...
public class FloatField extends AbstractField<Doublebox> {
    ...
    public SearchFilter getSearchFilter() {
        ...
        final FloatFilter f = new FloatFilter(getFieldName());
        final Float v = T9tUtil.asFloat(components.get(0).getValue());
        ...
        case RANGE:
            f.setLowerBound(v);
            f.setUpperBound(T9tUtil.asFloat(components.get(1).getValue()));
            break;
        case UPPER_BOUND:
            f.setUpperBound(v);
            break;
    ...
    public FloatField(String fieldname, UIFilter cfg, FieldDefinition desc, String gridId, ApplicationSession session) {
