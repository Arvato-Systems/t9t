...
public class DropdownDbAsIntegerDataField extends AbstractDropdownDataField<Ref, Integer> {
    ...
    @Override
    protected Integer extractValue(final Description desc) {
        return Integer.valueOf(desc.getId());
    }

    @Override
    protected Description lookupDescription(final Integer data) {
        return c.lookupByKey(data.toString());
    }
}
