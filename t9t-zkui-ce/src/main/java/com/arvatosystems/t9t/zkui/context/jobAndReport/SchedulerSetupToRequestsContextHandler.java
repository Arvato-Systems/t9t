...
@Singleton
@Named("schedulerSetup.ctx.showRequests")
public class SchedulerSetupToRequestsContextHandler implements IGridContextMenu<SchedulerSetupDTO> {
    ...
    public void selected(final Grid28 lb, final DataWithTracking<SchedulerSetupDTO, TrackingBase> dwt) {
        ...
        JumpTool.jump("screens/monitoring/requests28.zul", "invokingProcessRef", dto.getObjectRef(), "screens/scheduler/schedulerSetup28.zul");
    }
}
