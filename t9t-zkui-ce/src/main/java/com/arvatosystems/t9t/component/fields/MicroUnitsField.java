...
public class MicroUnitsField extends AbstractField<Decimalbox> {
    @Override
    ...
    public MicroUnitsField(String fieldname, UIFilter cfg, FieldDefinition desc, String gridId, ApplicationSession session) {
