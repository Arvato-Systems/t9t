...
public interface IAuthorize {
    ...
    Permissionset EXEC_PERMISSION = new Permissionset(1 << OperationType.EXECUTE.ordinal());
    Permissionset ALL_PERMISSIONS = new Permissionset(0xfffff);  // 20 permission bits all set
