...
//                }
                ...
                resolverClass => [
                    ...
                    // produce the method to return the table name
                    addMethod("getDatabaseTablename") [
                        visibility = Visibility::PUBLIC
                        returnType = stringType
                        docComment = "Returns the SQL tablename of the database table used to store instances of the related entity"
                        final = true
                        addAnnotation(overrideAnno)
                        body = [ '''
                            return «toJavaCode(Tools.getRoot(rt))».TABLE_NAME;
                        ''']
                    ]
