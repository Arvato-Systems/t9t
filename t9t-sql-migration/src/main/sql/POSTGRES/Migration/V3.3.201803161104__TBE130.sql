...
/*
    ...
    limitations under the License.
*/
ALTER TABLE p28_his_scheduler_setup ADD COLUMN additional_permissions varchar(255);
ALTER TABLE p28_cfg_scheduler_setup ADD COLUMN additional_permissions varchar(255);
