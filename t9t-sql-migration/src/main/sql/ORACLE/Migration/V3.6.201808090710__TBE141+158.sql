...
DROP TABLE p28_his_async_channel CASCADE;
DROP TABLE p28_cfg_async_channel CASCADE;
DROP TABLE p28_his_async_queue CASCADE;
DROP TABLE p28_cfg_async_queue CASCADE;
...
CREATE TABLE p28_cfg_async_queue (
    ...
    , async_queue_id varchar2(16 char) NOT NULL
    , is_active number(1) NOT NULL
    , description varchar2(80 char) NOT NULL
    , default_serializer_qualifier varchar2(32 char)
    , sender_qualifier varchar2(32 char)
    , max_message_at_startup number(10)
    , timeout_idle_green number(10)
    , timeout_idle_red number(10)
    , timeout_external number(10)
    , wait_after_ext_error number(10)
    , wait_after_db_errors number(10)
    , max_age_in_seconds number(10)
    , purge_after_seconds number(10)
    , z varchar2(4000)
...
CREATE TABLE p28_cfg_async_channel (
    ...
    , is_active number(1) NOT NULL
    , description varchar2(80 char) NOT NULL
    , async_queue_ref number(20)
    , url varchar2(255 char) NOT NULL
    , auth_type varchar2(16 char)
    , auth_param varchar2(255 char)
    , max_retries number(10)
    , payload_format varchar2(1) NOT NULL
    , serializer_qualifier varchar2(32 char)
    , timeout_in_ms number(10)
    , z varchar2(4000)
) TABLESPACE rts42dat0D;
...
CREATE TABLE p42_int_async_messages (
    ...
    , ref_type varchar2(4)
    , ref_identifier varchar2(36 char)
    , ref number(20)
    , http_response_code number(10)
    , return_code number(10)
    , reference varchar2(80 char)
) TABLESPACE rts42dat0D;
