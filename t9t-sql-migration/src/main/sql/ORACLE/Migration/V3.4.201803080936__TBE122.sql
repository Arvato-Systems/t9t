...
GRANT SELECT,INSERT,UPDATE,DELETE ON p28_dat_bpmn2_message_queue TO p42user;
GRANT SELECT ON p28_dat_bpmn2_message_queue TO p42ro;
GRANT SELECT,INSERT,UPDATE,DELETE ON p28_dat_bpmn2_message_queue TO p42rw;
...
/* Create Camunda BPMN tables.
 * The following create statements are included from Camunda BPMN distribution.
 */
