...
public abstract class AbstractCrudSuperclassKey42RequestHandler<
...
> extends AbstractCrudAnyKey42RequestHandler<KEY, DTO, TRACKING, REQUEST, ENTITY> {
    ...
    public CrudSuperclassKeyResponse<KEY, DTO, TRACKING> execute(
            final RequestContext ctx, final IEntityMapper42<KEY, DTO, TRACKING, ENTITY> mapper,
            final IResolverSuperclassKey42<REF, KEY, TRACKING, ENTITY> resolver,
