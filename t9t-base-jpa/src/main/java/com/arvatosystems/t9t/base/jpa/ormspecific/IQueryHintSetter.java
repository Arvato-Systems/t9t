...
public interface IQueryHintSetter {
    ...
    default void setManualFlushMode(final EntityManager em) { }

    /** Set all queries in a session by default to read-only (true) or read/write (false). */
    default void setReadOnly(final EntityManager em, final Object entity, final boolean readOnly) { }

    /** Set all queries in a session by default to read-only. */
    default void setReadOnlySession(final EntityManager em) { }
    ...
    default void setReadOnly(final CriteriaQuery<?> q) { }

    /** Provide a query comment. This usually appears in the logs and can be used to identify the source. */
    default void setComment(final CriteriaQuery<?> q, final String text) { }
