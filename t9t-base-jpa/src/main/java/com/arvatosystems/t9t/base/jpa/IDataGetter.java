...
public interface IDataGetter {
    ...
    <D extends Ref> GetDataResponse<D> query(IResolverSurrogateKey resolver, String constructor, Class<D> keyClass, Set<Long> refs);

    /** Query data using some DTO mapping. */
    <D extends Ref, E extends BonaKey<Long> & BonaData<D>> GetDataResponse<D> query(IResolverSurrogateKey resolver, Class<E> entityClass,
