...
> extends AbstractCrudAnyKey42RequestHandler<String, DTO, TRACKING, REQUEST, ENTITY> {
    ...
    public CrudStringKeyResponse<DTO, TRACKING> execute(final RequestContext ctx, final IEntityMapper42<String, DTO, TRACKING, ENTITY> mapper,
            final IResolverStringKey42<TRACKING, ENTITY> resolver, final REQUEST crudRequest) {
