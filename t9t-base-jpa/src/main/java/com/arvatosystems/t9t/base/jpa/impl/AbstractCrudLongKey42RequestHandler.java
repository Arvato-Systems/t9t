...
> extends AbstractCrudAnyKey42RequestHandler<Long, DTO, TRACKING, REQUEST, ENTITY> {
    ...
    public CrudLongKeyResponse<DTO, TRACKING> execute(final RequestContext ctx, final IEntityMapper42<Long, DTO, TRACKING, ENTITY> mapper,
            final IResolverLongKey42<TRACKING, ENTITY> resolver, final REQUEST crudRequest) {
