...
> extends AbstractCrudAnyKey28RequestHandler<KEY, DTO, TRACKING, REQUEST, ENTITY> {
    ...
    public CrudCompositeKeyResponse<KEY, DTO, TRACKING> execute(final RequestContext ctx, final IEntityMapper28<KEY, DTO, TRACKING, ENTITY> mapper,
            final IResolverCompositeKey28<KEY, KEY, TRACKING, ENTITY> resolver, final REQUEST crudRequest) {
     ...
     * @return
     */
    protected boolean recordExists(final KEY key, final IResolverCompositeKey28<KEY, KEY, TRACKING, ENTITY> resolver) {
        try {
