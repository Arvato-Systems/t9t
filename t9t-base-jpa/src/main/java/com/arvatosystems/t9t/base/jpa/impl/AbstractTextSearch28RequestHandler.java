...
public abstract class AbstractTextSearch28RequestHandler<REF extends Ref, DTO extends REF, TRACKING extends TrackingBase, REQ extends Search28Request<DTO, TRACKING>, ENTITY extends BonaPersistableKey<Long> & BonaPersistableTracking<TRACKING>>
    ...
    public AbstractTextSearch28RequestHandler(final IResolverSurrogateKey28<REF, TRACKING, ENTITY> resolver,
            final IEntityMapper28<Long, DTO, TRACKING, ENTITY> mapper, final List<String> textSearchOnlyPathElements,
    ...
    public ReadAll28Response<DTO, TRACKING> execute(final RequestContext ctx, final REQ rq) throws Exception {
        if (!(rq.getExpression() == null || rq.getExpression().isEmpty())
                || searchTools.containsFieldPathElements(rq, textSearchOnlyPathElements)) {
            ...
            if (refs.isEmpty()) {
                final ReadAll28Response<DTO, TRACKING> resp = new ReadAll28Response<DTO, TRACKING>();
            ...
            return this.mapper.createReadAllResponse(this.resolver.search(newSearchRq, null),
