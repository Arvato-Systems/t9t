...
public interface IPluginMethodLifecycle {
    ...
    default void registerPluginMethod(final Long tenantRef, final Plugin loadedPlugin, final PluginMethod method, final boolean before) { }

    /** This method is called twice during plugin initialization, once before the method is added to the dispatcher, once afterwards. */
    default void unregisterPluginMethod(final Long tenantRef, final Plugin loadedPlugin, final PluginMethod method, final boolean before) { }
}
