...
public class IndexCreationFromScratchRequestHandler extends AbstractRequestHandler<IndexCreationFromScratchRequest> {
    ...
    @Nonnull
    @Override
    public ServiceResponse execute(@Nonnull final RequestContext ctx, @Nonnull final IndexCreationFromScratchRequest request) throws Exception {
        ...
        // Recreate the index
        service.createIndexesFromScratch(ctx, entityClass);
