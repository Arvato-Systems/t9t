...
class LeanAsyncChannelSearchRequestHandler extends AbstractLeanSearchRequestHandler<LeanAsyncChannelSearchRequest, AsyncChannelEntity> {
    new() {
        super(Jdp.getRequired(IAsyncChannelEntityResolver),
            [ return new Description(null, asyncChannelId, description, false, false) ]
        )
    }
}
