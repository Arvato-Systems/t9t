...
public class MailOutTransformer implements ICamelOutMessageTransformer {
    ...
    @Override
    public Exchange transformMessage(final Exchange exchange, final Endpoint endpoint) {
        final Message in = exchange.getIn();
        in.setBody("autogenerated mail providing the exported document");

        final AttachmentMessage am = exchange.getMessage(AttachmentMessage.class);
        am.addAttachment(in.getHeader(Exchange.FILE_NAME, String.class), new DataHandler(new FileDataSource(in.getHeader("fileName", String.class))));
