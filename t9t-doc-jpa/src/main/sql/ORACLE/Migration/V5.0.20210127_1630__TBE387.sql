-- TBE-387: migration of MailingGroupEntity (ORACLE)

DROP INDEX p28_cfg_report_mailing_u1;
ALTER TABLE p28_cfg_report_mailing RENAME TO p28_cfg_mailing_group;
ALTER TABLE p28_cfg_mailing_group ADD description varchar2(80 char);
...
ALTER TABLE p28_his_mailing_group ADD description varchar(80);
...
ALTER TABLE p28_cfg_mailing_group MODIFY ( description NOT NULL);
ALTER TABLE p28_his_mailing_group MODIFY ( description NOT NULL);
