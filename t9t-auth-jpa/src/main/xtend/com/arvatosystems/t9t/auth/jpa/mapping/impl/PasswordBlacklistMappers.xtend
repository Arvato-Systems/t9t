...
@AutoMap42
class PasswordBlacklistMappers {
    IPasswordBlacklistEntityResolver resolver

    @AutoHandler("S42")
    def void e2dPasswordBlacklistDTO(PasswordBlacklistEntity entity, PasswordBlacklistDTO dto) {}
}
