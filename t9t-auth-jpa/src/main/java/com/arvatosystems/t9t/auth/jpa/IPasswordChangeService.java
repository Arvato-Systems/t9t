...
public interface IPasswordChangeService {
    /** This method is invoked if the user changes her/his password. */
    void changePassword(String newPassword, UserEntity userEntity, UserStatusEntity userStatusEntity);
}
