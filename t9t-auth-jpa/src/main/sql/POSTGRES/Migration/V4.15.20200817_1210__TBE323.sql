-- TBE-323: add salutation and orgUnit to user table - POSTGRES

DROP VIEW IF EXISTS p42_cfg_users_nt ;
DROP VIEW IF EXISTS p42_cfg_users_v;

ALTER TABLE p42_cfg_users ADD COLUMN salutation varchar(80);
ALTER TABLE p42_cfg_users ADD COLUMN org_unit   varchar(16);

ALTER TABLE p42_his_users ADD COLUMN salutation varchar(80);
ALTER TABLE p42_his_users ADD COLUMN org_unit   varchar(16);
